  ...
  roles.host = {
    ...
    interface = { lib, ... }: {
      options = {
        ...
        primaryIPv4 = lib.mkOption { type = lib.types.strMatching "[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+"; };
        secondaryIPv4 = lib.mkOption { type = lib.types.strMatching "[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+"; };
        prefixLength = lib.mkOption { type = lib.types.ints.between 0 32; };
        gateway = lib.mkOption { type = lib.types.strMatching "[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+"; };
